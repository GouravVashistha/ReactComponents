...
const BootstrapMultiCarousal = () => {
    ...
    return (
        ...
        <div  style={{width:'80%'}}>
         <h1 style={{display:'flex',justifyContent:'center',textTransform:'uppercase',textDecoration:'underline ',color:'green'}}>Best Offer</h1>
            <Slider 
            slidesToScroll={3}
...
const Card=({item})=>{
    return(
        <div style={{textAlign:'center' ,margin:20,padding:'0 10px',width:220, boxShadow: "0 1px 6px 0 rgb(32 33 36 / 28%)",
        borderRadius: 5,}}>
            ...
            <p style={{fontSize:"18px",padding:'2px 0',color:'gray',fontWeight:400}}>TOP TRNDING TVs</p>
